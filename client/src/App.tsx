  ...
  return <div className="app-shell"><div className="ambient" /><div className="topline" />
    <header className={`navbar ${scrolled ? "scrolled" : ""}`}>
      <div className="container nav-inner">
        <Link href="/" className="brand" aria-label="Claude Code Académie francophone, accueil"><span className="brand-mark"><span>›_</span></span><span>CLAUDE CODE<small>Académie francophone</small></span></Link>
  ...
  return <>
    <main>
      <section className="hero"><div className="container hero-grid"><div>
        ...
        <div className="hero-meta"><div className="avatar-stack"><span className="avatar">AM</span><span className="avatar">SL</span><span className="avatar">NK</span></div><span><strong>+2 400</strong> développeurs apprennent déjà en pratiquant</span></div><div className="creator-credit">Créé par <strong>Imad LEHOUARA</strong></div>
...
function Footer() { return <footer className="footer"><div className="container"><div className="footer-grid"><div className="footer-brand"><Link href="/" className="brand"><span className="brand-mark"><span>›_</span></span><span>CLAUDE CODE<small>Académie francophone</small></span></Link><p>Une plateforme francophone pour apprendre Claude Code en pratiquant, pas en collectionnant les onglets.</p><div className="creator-signature"><a className="creator-logo-link" href="https://www.linkedin.com/in/lehouaraimad?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer" aria-label="Voir le profil LinkedIn d’Imad LEHOUARA"><img className="creator-logo-image" src="/manus-storage/139186_16e1744f.png" alt="Logo Imad LEHOUARA" /><span className="creator-tooltip" role="tooltip">Voir le profil LinkedIn</span></a><span><small>Créé par</small><strong>Imad LEHOUARA</strong></span></div></div><div className="footer-col"><h4>Apprendre</h4><Link href="/apprendre">Modules</Link><Link href="/evaluation">Évaluation</Link><Link href="/">Parcours</Link></div><div className="footer-col"><h4>Pratiquer</h4><Link href="/laboratoire">Laboratoire</Link><Link href="/generateur">Config Builder</Link><Link href="/cheat-sheet">Cheat Sheet</Link></div><div className="footer-col"><h4>Projet</h4><Link href="/index">Index</Link><Link href="/ressources">Ressources</Link><Link href="/feedback">Feedback</Link><Link href="/changelog">Changelog</Link></div></div><div className="footer-bottom"><span>© 2026 Claude Code Académie</span><span>Fait pour apprendre, tester et transmettre.</span></div></div></footer>; }
